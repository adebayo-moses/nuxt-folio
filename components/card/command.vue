<template>
  <div class="card bg-gray-100 h-146 flex flex-col justify-between">
    <div>
      <div>
        <h2 class="inline-flex">Experience</h2>
        <lib-badge class="ml-2">coming soon fam</lib-badge>
      </div>
      <p>Currently I’m working as a Community Manager and a Freelancer</p>
    </div>
      ...
      <div class="results">
        <div class="content">
          <ul>
            ...
            <li class="active">About mosessmax</li>
          </ul>
          <ul>
            <span>Section Name</span>
            <li>Skills</li>
    ...
    <div class="notification">
        Hit <lib-badge class="mx-2" :variant="'box'">Ctrl + K</lib-badge> to try it
    </div>
  </div>
</template>
